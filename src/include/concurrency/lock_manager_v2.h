...
class LockManagerV2 {
 ...
 private:
  ...
  auto UpgradeLockTable(TransactionWith2PL *txn, LockMode lock_mode, const table_oid_t &oid, LockRequestQueue *lock_request_queue) -> bool;
  auto UpgradeLockRow(TransactionWith2PL *txn, LockMode lock_mode, const table_oid_t &oid, const RID &rid) -> bool;
  ...
  auto CheckAppropriateLockOnTable(TransactionWith2PL *txn, const table_oid_t &oid, LockMode row_lock_mode) -> bool;
